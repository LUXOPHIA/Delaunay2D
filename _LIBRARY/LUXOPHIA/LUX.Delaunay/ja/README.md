...
・LUX.Delaunay/
  ...
  ┃  ┣・LUX.Delaunay.D2.Viewer.pas / .fmx              ：TDelaunayViewer ― Skia 2D フレーム
  ┃  ┣・README.md , ja/README.md                       ：パッケージのドキュメント
  ┃  ┗・Periodic/                                      ：2D 平坦トーラス
  ┃     ┣・LUX.Delaunay.D2.Periodic.pas                ：TPeriDelaunay2D ― T² の三角形分割
  ┃     ┣・LUX.Delaunay.D2.Periodic.Viewer.pas/.fmx    ：TPeriDelaunayViewer ― Skia 2D フレーム
  ┃     ┗・README.md , ja/README.md                    ：パッケージのドキュメント
  ┗・D3/                                                ：3D ユークリッド空間
     ┣・LUX.Delaunay.D3.pas                             ：TDelaunay3D ― E³ の四面体分割
     ┣・LUX.Delaunay.D3.Viewer.pas / .fmx               ：TDelaunayViewer ― Viewport3D フレーム
     ┗・README.md , ja/README.md                        ：パッケージのドキュメント
```
