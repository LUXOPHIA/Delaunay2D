...
・TDelaunay2D                               ･･･ ( = TDelaFaceSet2D = face set )
  ...
  ┃  ┗・1..* TDelaFace2D
  ┃     ┣・Poin[1..3]                     ･･･ CCW; infinite faces hold PoinInf
  ┃     ┣・Face[1..3]                     ･･･ neighbours
  ┃     ┗・Corn[1..3]
...
・D2/
  ...
  ┃  ┣・TDelaPoin2D                            ･･･ vertex: Lift, InCircled
  ┃  ┣・TDelaPoin2DInf                         ･･･ ∞: Lift ≡ ( 0, 0, 1 )
  ┃  ┣・TDelaPoinSet2D                         ･･･ vertex set (finite only)
  ┃  ┣・TDelaFace2D                            ･･･ triangle: InfCorn, Circum
  ┃  ┣・TDelaFaceSet2D                         ･･･ face set
  ┃  ┗・TDelaunay2D                            ･･･ model: AddPoin/DeletePoin
